...
public class slotController {
    ...
    public String slotViewOrder1(@RequestParam Map<String, String> body, Model model,  HttpServletResponse response, HttpServletRequest request) {
        System.out.println("88888888888");
        System.out.println("body9:"+body);
        BookSlot bookSlot =  new BookSlot();
        System.out.println(bookSlot);

        bookSlot.setBookedBy(body.get("bookedBy"));
        System.out.println("body9:"+bookSlot.getGameDate());
        System.out.println("body10:"+bookSlot.getBookedBy());
        System.out.println("body11:"+body.get("bookedBy"));
        System.out.println("body12:"+body.get("gameDate"));
        LocalDate date= LocalDate.parse(body.get("gameDate"));
        String bookedBy= body.get("bookedBy");
      //  List<BookSlot> list = bookSlotRepository.findByBookedByAndGameDate("8096572471", LocalDate.parse("2023-07-20"));
//        System.out.println("list:"+list);
//        model.addAttribute("list", list);
//        System.out.println("Excel Size -- " + list.size());
        return "customer/viewSlots";
